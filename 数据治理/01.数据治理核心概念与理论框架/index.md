...
| 章节 | 核心内容 | 关键知识点 |
| :--- | :--- | :--- |
| **1.1 定义与边界** | 厘清概念，划定范围 | **决策权 (Decision Rights)**、**责权对等**、**资产负债表论** |
| **1.2 DAMA 体系** | 全球标准解读 | **DAMA Wheel**、**11 个知识领域**、**环境因素** |
| **1.3 方法论** | 落地实施指南 | **业务导向**、**急用先行**、**PDCA 循环** |
