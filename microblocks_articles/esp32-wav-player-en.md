...
url: "https://learn.microblocks.fun/en/activities/esp32-wav-player-en"
slug: "esp32-wav-player-en"
---
...
We'll use a bitmap create with a paint program as the header for the M5Stack. The M5 display is 320x240 pixels so the header image is the same width: 320x55 pixels.
 ...
 Since it has a smaller screen, the ED1 version omits the bitmap header image and draws the header as text.
